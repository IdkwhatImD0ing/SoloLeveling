...
export default function Landing() {
  return (
    ...
    <div>...</div>
              </div><div className = "home__hero-3">
    <div>Working out wasn't just a chore</div> < /div> */}
              <div className="home__hero-4">
                <div>But a game?</div>
              </div>
            </div>
            <h1 className="hero__h1">
              Introducing Questify, the app that transforms your workout routine
              into an exciting game, motivating you to level up your fitness
